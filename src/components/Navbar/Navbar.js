    ...
    <div className="Navbar">
          ...
          <a href="https://github.com/santdeleon" className="github-link" target="_blank" rel="noopener noreferrer">
            <svg width="19" height="22" version="1.1" viewBox="0 0 19 22">
              <g id="Symbols" fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <g id="Toolbar/Dark" fillRule="nonzero" stroke="#000" transform="translate(-46.000000, -2.000000)">
          ...
          <svg className="sun-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="23" version="1.1" viewBox="0 0 24 23">
            ...
            <g id="Sun" fill="none" fillRule="evenodd" stroke="#222" strokeWidth="1">
              <g id="Group" stroke="#222" transform="translate(1.000000, 0.000000)">
                ...
                <path id="Sun" strokeLinecap="round" d="M12.4412109,2.97817383 L9.39291538,2.97817383" transform="translate(10.484863, 2.478174) rotate(-90.000000) translate(-10.484863, -2.478174)"/>
                <path id="Sun" strokeLinecap="round" d="M19.0388351,4.43089148 L17.0824874,4.43089148" transform="translate(18.060661, 4.430891) rotate(-45.000000) translate(-18.060661, -4.430891)"/>
                <path id="Sun" strokeLinecap="round" d="M21.9697266,11.5066895 L19.0710812,11.5066895"/><path id="Sun" strokeLinecap="round" d="M19.0388351,18.5824874 L17.0824874,18.5824874" transform="translate(18.060661, 18.582487) rotate(45.000000) translate(-18.060661, -18.582487)"/>
                <path id="Sun" strokeLinecap="round" d="M12.9412109,21.5352051 L9.98809762,21.5352051" transform="translate(11.484863, 21.035205) rotate(90.000000) translate(-11.484863, -21.035205)"/>
                <path id="Sun" strokeLinecap="round" d="M4.88723914,18.5824874 L2.93089148,18.5824874" transform="translate(3.909065, 18.582487) rotate(135.000000) translate(-3.909065, -18.582487)"/>
                <path id="Sun" strokeLinecap="round" d="M3.00918598,11.5066895 L2.66453526e-14,11.5066895" transform="translate(1.504593, 11.506689) rotate(180.000000) translate(-1.504593, -11.506689)"/><path id="Sun" strokeLinecap="round" d="M4.88723914,4.43089148 L2.93089148,4.43089148" transform="translate(3.909065, 4.430891) rotate(225.000000) translate(-3.909065, -4.430891)"/>
              </g>
            </g>
          </svg>
        </div>
      ...
      <div className={`flex flex-column align-items-center menu-wrap ${(showSidebar === true) ? "menu-show" : ""}`}>
        <div className="sidebar-links flex flex-column align-items-center justify-content-center text-center">
          ...
          <a href="#" className="nav-item fromLeft" aria-label="Technologies">Technologies</a>
