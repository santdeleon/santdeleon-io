    ...
    <div id="Navbar" className="Navbar">
      <nav className="navbar flex align-items-center justify-content-between">
        ...
        <div className="nav-right flex align-items-center">
          ...
          <a href="https://github.com/santdeleon" className="github-link" target="_blank" rel="noopener noreferrer">
            <svg id="githubIcon" width="22" height="30" version="1.1" viewBox="0 0 19 22">
              <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <g fillRule="nonzero" stroke={`${(props.theme === "light") ? "#000" : "#9D9D9D"}`} transform="translate(-46.000000, -2.000000)">
          ...
          (props.theme === "dark")
          ?
            <svg id="sunIcon" className="sun-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="25" version="1.1" viewBox="0 0 24 23" aria-label="light mode button" onClick={props.toggleTheme}>
              <g fill="none" fillRule="evenodd" stroke="#9D9D9D" strokeWidth="1">
                <g stroke="#9D9D9D" transform="translate(1.000000, 0.000000)">
