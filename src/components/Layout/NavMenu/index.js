            ...
            >
              <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <g
                  ...
                  transform="translate(-46.000000, -2.000000)"
                >
                  <g transform="translate(0.000000, 2.000000)">
                    <path
                      className="github-icon-dimensions"
              ...
              <g fill="none" fillRule="evenodd" stroke="#fff" strokeWidth="1">
                <g stroke="#fff" transform="translate(1.000000, 0.000000)">
                  ...
                  <path
                    ...
                    transform="translate(10.484863, 2.478174) rotate(-90.000000) translate(-10.484863, -2.478174)"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M19.0388351,4.43089148 L17.0824874,4.43089148"
                    transform="translate(18.060661, 4.430891) rotate(-45.000000) translate(-18.060661, -4.430891)"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M21.9697266,11.5066895 L19.0710812,11.5066895"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M19.0388351,18.5824874 L17.0824874,18.5824874"
                    transform="translate(18.060661, 18.582487) rotate(45.000000) translate(-18.060661, -18.582487)"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M12.9412109,21.5352051 L9.98809762,21.5352051"
                    transform="translate(11.484863, 21.035205) rotate(90.000000) translate(-11.484863, -21.035205)"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M4.88723914,18.5824874 L2.93089148,18.5824874"
                    transform="translate(3.909065, 18.582487) rotate(135.000000) translate(-3.909065, -18.582487)"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M3.00918598,11.5066895 L2.66453526e-14,11.5066895"
                    transform="translate(1.504593, 11.506689) rotate(180.000000) translate(-1.504593, -11.506689)"
                  />
                  <path
                    className="sun"
                    strokeLinecap="round"
                    d="M4.88723914,4.43089148 L2.93089148,4.43089148"
                    transform="translate(3.909065, 4.430891) rotate(225.000000) translate(-3.909065, -4.430891)"
                  />
                </g>
              </g>
            </svg>
