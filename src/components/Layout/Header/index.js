    ...
    <div id="Header" className="Header container">
      <div className="header-wrapper flex flex-column justify-content-between">
        <div className="header-text flex flex-column">
          ...
          <h1 className="header-title mb-0 mt-0">
            Hello, I'm Sant. Blockchain engineer and front-end developer.
          </h1>
          <h3 className="header-name text-muted mt-3 fw-normal">
            with a knack for creating cutting edge products with elegance and
            style.
          </h3>
        </div>

        <div className="skills-wrapper flex w-100 justify-content-between mb-4">
          {skills.map(skill => {
            return (
              <div
                key={skill.id}
                className="skill flex flex-column mt-5"
                style={
                  theme === "light"
                    ? { backgroundColor: "#fff" }
